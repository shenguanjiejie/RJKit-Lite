...
- (UIButton *)addButtonWithFont:(UIFont *)font title:(NSString *)title titleColor:(UIColor *)titleColor image:(id)image{
    ...
    button.titleLabel.font = font?font:[UIFont systemFontOfSize:13];
    ...
    if (image) {
        if ([image isKindOfClass:[UIImage class]]) {
            ...
            [button sd_setImageWithURL:[NSURL URLWithString:image] forState:UIControlStateNormal placeholderImage:nil options:SDWebImageLowPriority completed:nil];
        }else if ([image isKindOfClass:[NSURL class]]){
            [button sd_setImageWithURL:image forState:UIControlStateNormal placeholderImage:nil options:SDWebImageLowPriority completed:nil];
        }
    }
...
- (UIImageView *)addImageViewWithImage:(id)image contentMode:(UIViewContentMode)contentMode{
    ...
    if (image) {
        if ([image isKindOfClass:[UIImage class]]) {
            ...
            [imageView sd_setImageWithURL:[NSURL URLWithString:image] placeholderImage:nil completed:nil];
        }else if ([image isKindOfClass:[NSURL class]]){
            [imageView sd_setImageWithURL:image placeholderImage:nil completed:nil];
        }
    }
...
- (UILabel *)addLabelWithFont:(UIFont *)font textColor:(UIColor *)textColor text:(NSString *)text{
    ...
    label.font = font?font:[UIFont systemFontOfSize:13];
...
- (UITextField *)addTextFieldWithFont:(UIFont *)font textColor:(UIColor *)textColor text:(NSString *)text keybordType:(UIKeyboardType)keyboardType{
    ...
    textField.font = font?font:[UIFont systemFontOfSize:13];
    textField.text = text;
...
-(UITextView *)addTextViewWithFont:(UIFont *)font textColor:(UIColor *)textColor text:(NSString *)text placeholder:(NSString *)placehodler{
    ...
    textView.font = font?font:[UIFont systemFontOfSize:13];
    textView.text = text;
